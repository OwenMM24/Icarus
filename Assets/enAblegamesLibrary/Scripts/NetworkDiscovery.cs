...
namespace NetworkDiscoveryUnity
{
	...
	public class NetworkDiscovery : MonoBehaviour
	{
		...
		public const string SignatureKey = "egGame";
		...
		void Awake ()
		{
			...
			RegisterResponseData(kSignatureKey, SignatureKey);
		...
		{
			if(info.KeyValuePairs.ContainsKey(kSignatureKey) && info.KeyValuePairs[kSignatureKey] == SignatureKey)
			{
				// signature matches
				// send response
		...
		static string GetCachedSignature()
		{
			...
			s_cachedSignature = SignatureKey;
